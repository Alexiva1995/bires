            ...
            <div class="row d-flex mt-4">
              <div class="mt3 ps-2 col col-sm-5 flex-start input-container">
	              <button type="submit" class="card-img-top card-size col-xs-12 col-sm-6 col-md-3 mx-auto rounded ">
	            		<img class="img-fluid card-img-size " src={{asset('images/zoe/payments/payu.png')}} alt="back-transfer">
	       				</button>
       				</div>
              <div class="col-1"></div>
              <div class="mb-3 ps-2 col col-sm-5 flex-end input-container" style="padding-right:0%;"> 
                <strong style="padding-left:15%;height: 41px;width: 264px;left: 0px;top: 0px;border-radius: undefinedpx; Font family: Poppinsfont-style: SemiBold;font-size: 24px;line-height: 44px;line-height: 100%;Align: Left;vertical-align: top;number-case:number-spacing:">
                  Método vía payu 
                </strong>
                ...
                <button type="submit" class="btn-sm text-white lead mt-2" style="height: 60px;width: 330.375px;left: 867px;top: 467px;border-radius: 4px;" data-bs-toggle="modal" data-bs-target="#modalpayu">
...
<!-- Modal -->
<div class="modal fade" id="modalpayu" tabindex="-1" role="dialog" aria-labelledby="modalpayuTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered  " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title " id="modalstripeTitle">Método de pago: PayU.</h5>
            ...
            <div class="modal-body text-justify primary-background">
                <form role="form" action="{{ route('payu.post') }}" method="post" class="require-validation"data-cc-on-file="false"  data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
                    @csrf
