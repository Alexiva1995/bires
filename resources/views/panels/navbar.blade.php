    ...
    <div class="navbar-container d-flex content">
      ...
      <ul class="nav navbar-nav align-items-center ms-auto">
        <li class="nav-item dropdown dropdown-notification">
          <a class="btn btn-sm btn-secondary" href="javascript:void(0);" data-bs-toggle="dropdown" style="margin-right: 15px;box-shadow: rgb(245, 167, 7) 5px 5px 3px 0px, rgb(245, 167, 7) 0px 3px 10px 0px, rgb(245, 167, 7) 3px -3px 10px 5px;">
            <i class="fa-solid fa-bell" style="font-size: 15px;box-shadow: rgb(255, 255, 255) 5px 5px 20px 0px, rgb(255, 255, 255) 0px 3px 10px 0px, rgb(255, 255, 255)
            "></i>@if(count(auth()->user()->unreadNotifications) > 0)
              ...
              <a class="d-flex" href="javascript:void(0)">
                <div class="list-item d-flex align-items-start">
                  <div class="list-item-body flex-grow-1">
                    <p class="notification-text"> {{$notificaciones->data['message']}}.</p>
                  </div>
                </div>
              </a>
              @empty
              <p class="notification-text m-1"> Sin notificaciones.</p>
              @endforelse
        ...
        <li class="nav-item dropdown dropdown-language">
          ...
          <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-flag">
            ...
            <a href="#googtrans(es|en)" class="dropdown-item lang-select rounded" data-language="en" alt="INGLES">
              <i class="flag-icon flag-icon-us"></i> EN
            </a>
            <a href="#googtrans(es|fr)" class="dropdown-item lang-select rounded" data-language="fr" alt="FRANCÉS">
              <i class="flag-icon flag-icon-fr"></i> FR
            </a>
            <a href="#googtrans(es|de)" class="dropdown-item lang-select rounded" data-language="de" alt="ALEMÁN">
              <i class="flag-icon flag-icon-de"></i> AL
            </a>
            <a href="#googtrans(es|pt)" class="dropdown-item lang-select rounded" data-language="pt" alt="PORTUGUÉS">
